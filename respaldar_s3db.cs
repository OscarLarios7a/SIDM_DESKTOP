...
namespace gsBuscar_cs
{
    class respaldar_s3db
    {
        ...
        public void RellenarGrid_CompaqSQLCaptura(string consulta, string ruta, DataGridView Grid)
        {
            try
            {
                string SqlCeConfig = @"Data Source=" + ruta;
        ...
        public void RellenarGrid_CompaqSQLCapturaCerm(string consulta, string ruta, DataGridView Grid)
        {
            try
            {
                string SqlCeConfig = @"Data Source=" + ruta;
        ...
        public void Generar_Consulta(DataGridView dgv, string archivo)
        {
            ...
            for (int i = 0; i <= dgv.Rows.Count - 2; i++)
            {
                ...
                folio = dgv.Rows[i].Cells["FOLIO_CRIS"].Value.ToString();
        ...
        public void Generar_ConsultaCaptura(DataGridView dgv, string archivo)
        {
            string idPregunta = "", pregunta="", idCodResp = "", obsRespuesta = "", folioEncuesta = "";
            string consulta = "";
            ...
            for (int i = 0; i <= dgv.Rows.Count - 2; i++)
            {
                idPregunta = dgv.Rows[i].Cells["ID_PREGUNTA"].Value.ToString();
                pregunta = dgv.Rows[i].Cells["TEXTO_PREGUNTA"].Value.ToString();
                idCodResp = dgv.Rows[i].Cells["ID_CODIGO_RESPUESTA"].Value.ToString();
                obsRespuesta = dgv.Rows[i].Cells["RESPUESTA"].Value.ToString();
                folioEncuesta = dgv.Rows[i].Cells["FOLIO_ENCUESTA"].Value.ToString();
                ...
                consulta = "INSERT INTO escuela(idPregunta,txtPregunta,idRespuesta,txtRespuesta,folioEncuesta) " +
                            "VALUES('" + idPregunta + "','" + pregunta + "','" + idCodResp + "','" + obsRespuesta + "','" + folioEncuesta + "');";
        ...
        public void Generar_ConsultaCapturaCerm(DataGridView dgv, string archivo)
        {
            string idPregunta = "", pregunta = "", idCodResp = "", obsRespuesta = "", folioEncuesta = "";
            string consulta = "";
            ...
            for (int i = 0; i <= dgv.Rows.Count - 2; i++)
            {
                ...
                consulta = "INSERT INTO cerm(idPregunta,txtPregunta,idRespuesta,txtRespuesta,folioEncuesta) " +
                            "VALUES('" + idPregunta + "','" + pregunta + "','" + idCodResp + "','" + obsRespuesta + "','" + folioEncuesta + "');";
