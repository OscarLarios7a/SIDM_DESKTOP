...
namespace SIDM_V_1
{
    class Export_to
    {
        ...
        public void Exportar_to_cvs( DataGridView datos)
        {
            try
            {
                ...
                FileStream fs = new FileStream(@"c:\reporte.csv", FileMode.Create,FileAccess.ReadWrite);
        ...
        public void Exportar_pdf(DataGridView dg)
        {
            try
            {
                ...
                string filename = @"c:\DataGridViewTest.pdf";
